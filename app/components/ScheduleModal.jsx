...
export default function ScheduleModal({ isOpen, onClose }) {
  ...
  const handleSubmit = (e) => {
    ...
    const message = `Olá! Meu nome é ${name}, da empresa ${company}. Gostaria de agendar o ${packageName} para estruturar a presença digital e otimização de IA do meu negócio. Telefone: ${phone}`;
    ...
    <div style={{
      ...
      <div className="glass-card" style={{
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <button type="submit" className="btn-gold" style={{ marginTop: "12px", justifyContent: "center", padding: "16px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", fontSize: "0.8rem", color: "var(--text-dim)", marginTop: "8px" }}>
            <ShieldCheck size={14} color="var(--gold-primary)" /> Dados protegidos. Sem compromisso de contratação mensal.
          </div>
