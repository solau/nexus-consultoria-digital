    ...
    <section className="section-padding" style={{ background: "#050914", borderTop: "1px solid rgba(0, 242, 254, 0.1)", borderBottom: "1px solid rgba(0, 242, 254, 0.1)" }}>
      <div className="container">
        ...
        <div className="grid-3" style={{ marginBottom: "40px" }}>
          ...
          <div className="glass-card" style={{ padding: "32px 24px", border: "1px solid rgba(239, 68, 68, 0.3)", background: "rgba(239, 68, 68, 0.04)" }}>
            <div style={{ background: "rgba(239, 68, 68, 0.15)", width: "48px", height: "48px", borderRadius: "12px", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "20px" }}>
              <Ban size={24} color="#ef4444" />
            </div>
            <h3 style={{ fontSize: "1.25rem", color: "#fff", fontWeight: 800, marginBottom: "10px" }}>
          ...
          <div className="glass-card" style={{ padding: "32px 24px", border: "1px solid rgba(245, 158, 11, 0.3)", background: "rgba(245, 158, 11, 0.04)" }}>
          ...
          <div className="glass-card" style={{ padding: "32px 24px", border: "1px solid rgba(59, 130, 246, 0.3)", background: "rgba(59, 130, 246, 0.04)" }}>
            <div style={{ background: "rgba(59, 130, 246, 0.15)", width: "48px", height: "48px", borderRadius: "12px", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "20px" }}>
              <ShieldAlert size={24} color="var(--blue-light)" />
            </div>
            <h3 style={{ fontSize: "1.25rem", color: "#fff", fontWeight: 800, marginBottom: "10px" }}>
        ...
        <div className="pain-solution-banner" style={{
          ...
          <div style={{ maxWidth: "720px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "8px", color: "var(--blue-cyan)", fontWeight: 700, fontSize: "0.92rem", marginBottom: "10px" }}>
              <Flame size={18} /> A Virada de Chave com a DS IA
            </div>
          ...
          <div style={{ width: "100%", maxWidth: "260px" }} className="banner-btn-box">
            <button className="btn-blue" onClick={onOpenModal} style={{ fontSize: "1rem", padding: "16px 28px", width: "100%", justifyContent: "center" }}>
              Destravar Meus Leads Quentes <ArrowRight size={18} />
            </button>
          </div>
        </div>
