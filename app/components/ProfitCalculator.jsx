      ...
      <div className="container">
        ...
        <div style={{ textAlign: "center", maxWidth: "800px", margin: "0 auto 60px auto" }}>
          ...
          <h2 style={{ fontSize: "2.5rem", fontWeight: 800, marginBottom: "16px" }}>
            Calcule o Seu <span className="cyan-text">Potencial de Faturamento Extra</span>
          </h2>
        ...
        <div className="glass-card" style={{ maxWidth: "840px", margin: "0 auto", padding: "40px", border: "1px solid var(--border-blue)" }}>
          ...
          <div className="grid-2" style={{ marginBottom: "40px", gap: "40px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "28px" }}>
              ...
              <div>
                <label style={{ display: "flex", justifyContent: "space-between", color: "#fff", fontSize: "0.95rem", fontWeight: 600, marginBottom: "12px" }}>
                  ...
                  <span style={{ color: "var(--blue-cyan)", fontWeight: 800 }}>R$ {ticket.toLocaleString("pt-BR")}</span>
                </label>
                <input
                  type="range"
                  min="500"
              ...
              <div>
                <label style={{ display: "flex", justifyContent: "space-between", color: "#fff", fontSize: "0.95rem", fontWeight: 600, marginBottom: "12px" }}>
                  ...
                  <span style={{ color: "var(--blue-cyan)", fontWeight: 800 }}>{currentLeads} contatos</span>
                </label>
                <input
                  type="range"
                  min="5"
            ...
            <div style={{ background: "rgba(0,0,0,0.4)", borderRadius: "16px", padding: "28px", border: "1px solid var(--border-glass)", display: "flex", flexDirection: "column", justifyContent: "center" }}>
              ...
              <span style={{ fontSize: "2.8rem", fontWeight: 900, color: "var(--blue-cyan)", lineHeight: 1.1, marginBottom: "12px" }}>
          ...
          <div style={{ textAlign: "center" }}>
            <button className="btn-blue" onClick={onOpenModal} style={{ fontSize: "1.05rem", padding: "16px 36px" }}>
